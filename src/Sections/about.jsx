...
const About = () => {
  return (
    ...
    >
      {/* Section title */}
      <h1 className="group absolute top-5 left-1/6 text-[3rem] font-caveatbrush text-[#3A2A1F]">
        Hey, I'm Shaurya!
        <img
          ...
          alt="What's Up?"
          className="
          w-20 absolute right-20 rotate-75 top-50
          opacity-100 group-hover:opacity-100 group-hover:-right-1/6
